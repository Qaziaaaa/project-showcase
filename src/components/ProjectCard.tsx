  ...
  return (
    ...
    >
      ...
      <div className="p-4 pb-0">
        <div className="w-full h-56 rounded-3xl overflow-hidden border border-white/5 group-hover:border-orange-500/30 transition-colors duration-500 relative">
          <PremiumPreview 
            title={project.title}
          ...
          <div className="absolute inset-0 -translate-x-full group-hover:animate-shimmer bg-gradient-to-r from-transparent via-white/5 to-transparent pointer-events-none"></div>
        </div>
      </div>
