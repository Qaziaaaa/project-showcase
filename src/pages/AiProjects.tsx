      ...
      <Container>
        <div className="mb-12">
          ...
          <p className="text-lg text-gray-300 max-w-2xl">
            Intelligent applications powered by large language models, RAG pipelines, vector databases, and modern AI tooling.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {aiProjects.slice(0, visibleCount).map(project => (
            <ProjectCard key={project.slug} project={project} />
          ))}
        </div>

        {visibleCount < aiProjects.length && (
